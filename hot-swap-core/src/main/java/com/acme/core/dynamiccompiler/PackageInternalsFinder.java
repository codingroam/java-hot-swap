        ...
        try {
            ...
            while (entryEnum.hasMoreElements()) {
                ...
                if (name.startsWith(rootEntryName) && name.indexOf('/', rootEnd) == -1 && name.endsWith(CLASS_FILE_EXTENSION)) {
                    ...
                    result.add(new com.acme.core.dynamiccompiler.CustomJavaFileObject(binaryName, uri));
                }
            }
        } catch (Exception e) {
        ...
        for (File childFile : childFiles) {
            if (childFile.isFile()) {
                ...
                if (childFile.getName().endsWith(CLASS_FILE_EXTENSION)) {
                    ...
                    result.add(new com.acme.core.dynamiccompiler.CustomJavaFileObject(binaryName, childFile.toURI()));
                }
            }
        }
