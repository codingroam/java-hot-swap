...
public class DynamicJavaFileManager extends ForwardingJavaFileManager<JavaFileManager> {
    ...
    private final List<com.acme.core.dynamiccompiler.MemoryByteCode> byteCodes = new ArrayList<com.acme.core.dynamiccompiler.MemoryByteCode>();
    ...
    public JavaFileObject getJavaFileForOutput(Location location, String className,
        ...
        for (com.acme.core.dynamiccompiler.MemoryByteCode byteCode : byteCodes) {
            if (byteCode.getClassName().equals(className)) {
                return byteCode;
            }
        }

        com.acme.core.dynamiccompiler.MemoryByteCode innerClass = new com.acme.core.dynamiccompiler.MemoryByteCode(className);
