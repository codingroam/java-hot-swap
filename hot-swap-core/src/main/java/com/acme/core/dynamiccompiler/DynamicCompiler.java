...
public class DynamicCompiler {
    ...
    public void addSource(String className, String source) {
        addSource(new com.acme.core.dynamiccompiler.StringSource(className, source));
    }
    ...
    public Map<String, Class<?>> build() {
        ...
        JavaFileManager fileManager = new com.acme.core.dynamiccompiler.DynamicJavaFileManager(standardFileManager, dynamicClassLoader);
        ...
        try {
            ...
            if (!compilationUnits.isEmpty()) {
                ...
                if (!result || collector.getDiagnostics().size() > 0) {
                    ...
                    if (!errors.isEmpty()) {
                        throw new com.acme.core.dynamiccompiler.DynamicCompilerException("Compilation Error", errors);
                    }
                }
            }
            ...
            throw new com.acme.core.dynamiccompiler.DynamicCompilerException(e, errors);
        } finally {
